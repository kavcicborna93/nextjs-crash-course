            ...
            <div className="details">
                <div className="content">
                    ...
                    <section className="flex-col-gap-2">
                        ...
                        <EventDetailItem icon="/icons/time.svg" alt="clock" label={time}></EventDetailItem>
                        <EventDetailItem icon="/icons/pin.svg" alt="calendar" label={location}></EventDetailItem>
                        <EventDetailItem icon="/icons/mode.svg" alt="calendar" label={mode}></EventDetailItem>
